...
export const normalizeVenue = (venue = {}) => {
  ...
  return {
    ...
    questionType: ["mixed", "true_false", "multiple_choice", "written"].includes(source.questionType) ? source.questionType : defaultVenue.questionType,
...
export const normalizeTemplate = (template = {}) => {
  ...
  return {
    ...
    questionType: ["mixed", "true_false", "multiple_choice", "written"].includes(source.questionType) ? source.questionType : "mixed",
...
export const makeTemplateBuildDraft = (template, venue = null) => {
  ...
  return {
    ...
    questionType: cleanTemplate.questionType,
    defaultQuestionSettings: {
