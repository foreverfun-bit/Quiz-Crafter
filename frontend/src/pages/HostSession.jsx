  ...
  const endSession = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn("Session hosted results columns unavailable:", error);
      }
      setGameStarted(true);
