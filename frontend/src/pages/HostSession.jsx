...
const PhonePlayPanel = ({ players, answers, activity, fairPlayStats, gradedAnswers, markAnswer, pointsPerQuestion, setMode }) => {
  ...
  const wageredAnswers = answers.filter((answer) => Number(answer.wagerAmount || 0) > 0);
