...
const HostSession = () => {
  ...
  const markAnswer = (answer, status, options = {}) => {
    ...
    const answerUsesWager = hasSubmittedWager(answer) || Number(answer.wagerAmount || 0) > 0;
