...
const HostSession = () => {
  ...
  const [attendance, setAttendance] = useState({ barHeadcount: { adults: "", kids: "" }, teamHeadcounts: {} });
  ...
  useEffect(() => {
    const loadSession = async () => {
      ...
      try {
        ...
        setAttendance({
          barHeadcount: normalizeHeadcount(data?.attendance?.barHeadcount),
  ...
  const updateBarHeadcount = (field, value) => setAttendance((current) => ({ ...current, barHeadcount: { ...normalizeHeadcount(current.barHeadcount), [field]: value } }));
