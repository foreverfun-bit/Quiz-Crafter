...
const BuildSession = () => {
  ...
  return <div className="p-4 lg:p-6 max-w-7xl mx-auto animate-fade-in" data-testid="build-session-page">
    ...
    <BuildAssistantResults preview={chatPreview} onAcceptPreview={acceptChatPreview} onDiscardPreview={() => setChatPreview(null)} aiCandidates={aiCandidates} aiActionId={aiActionId} onAddToSession={handleAddAiCandidateToSession} onAddAll={handleAddAllAiCandidates} onSaveToLibrary={handleSaveAiCandidateToLibrary} onRegenerate={handleRegenerateAiCandidate} onConvertType={handleConvertAiCandidateType} onTuneDifficulty={handleTuneAiCandidateDifficulty} onStyleFeedback={handleAiStyleFeedback} />
...
const BuildAssistantResults = ({ preview, onAcceptPreview, onDiscardPreview, aiCandidates, aiActionId, onAddToSession, onAddAll, onSaveToLibrary, onRegenerate, onConvertType, onTuneDifficulty, onStyleFeedback }) => {
