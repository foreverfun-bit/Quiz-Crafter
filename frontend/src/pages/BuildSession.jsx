...
const BuildSession = () => {
  ...
  const handleAssistWriteQuestion = async () => {
    ...
    try {
      ...
      const draftCategoryExclusions = writeCategory ? selectedSessionCategories.filter((category) => categoryKey(category) !== categoryKey(writeCategory)) : selectedSessionCategories;
