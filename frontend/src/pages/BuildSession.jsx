  ...
  return (
    <label className="mt-2 inline-flex items-center gap-2 rounded-md border border-[#71E0DC]/25 bg-[#71E0DC]/10 px-2 py-1 text-xs font-semibold text-[#71E0DC]">
      ...
      <select
        ...
        className="h-7 rounded bg-zinc-950 border border-[#71E0DC]/30 px-2 text-xs text-white outline-none"
      >
        <option value="">Choose...</option>
        {otherRounds.map((round) => <option key={round.id} value={round.id}>{round.name}</option>)}
      </select>
    </label>
  );
};
