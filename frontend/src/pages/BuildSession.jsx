...
const BuildSession = () => {
  ...
  const handleGenerateImage = async (question) => {
    ...
    try {
      throw new Error("Image generation is not available yet. Use the image idea, then drag/drop a photo or paste a media URL.");
    } catch (error) {
