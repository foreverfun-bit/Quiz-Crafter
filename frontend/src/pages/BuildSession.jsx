...
const BuildSession = () => {
  ...
  const handleAiStyleFeedback = async (candidate, action) => {
    const labels = { keep: "Kept as your style", too_easy: "Marked too easy -- finding a harder replacement...", too_hard: "Marked too hard -- finding an easier replacement...", too_common: "Marked too common -- finding a fresher replacement...", not_my_style: "Marked not your style -- finding a replacement...", more_like_this: "Style memory updated", used_before: "Marked as already used -- finding something fresh..." };
    ...
    try {
      ...
      if (["too_common", "not_my_style", "too_hard", "used_before"].includes(action)) {
    ...
    else if (action === "too_common" || action === "not_my_style" || action === "used_before") handleRegenerateAiCandidate(candidate, "question");
  };
