...
const HostTools = () => {
  ...
  useEffect(() => {
    ...
    setAttendance({
      barHeadcount: normalizeHeadcount(saved.barHeadcount),
...
const HostReviewWorkspace = ({ selectedSession, analytics, questionFeedback, categoryRows, playerIdeas, exportResults, attendance, setAttendance }) => {
  ...
  const barHeadcount = normalizeHeadcount(attendance?.barHeadcount);
