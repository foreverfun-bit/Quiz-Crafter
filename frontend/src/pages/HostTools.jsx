...
const HostTools = () => {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto animate-fade-in" data-testid="host-tools-page">
      ...
      <HostReviewWorkspace selectedSession={selectedSession} analytics={analytics} questionFeedback={questionFeedback} categoryRows={categoryRows} playerIdeas={playerIdeas} message={message} setMessage={setMessage} sendUpdate={sendUpdate} openEmailDraft={openEmailDraft} copyEmails={copyEmails} contacts={allEmailContacts} exportResults={exportResults} scheduleNextShow={scheduleNextShow} buildNextSession={buildNextSession} aiDirection={aiDirection} setAiDirection={setAiDirection} generateClues={generateClues} generating={generating} clueQuestionRows={clueQuestionRows} selectedClueKeys={selectedClueKeys} setSelectedClueKeys={setSelectedClueKeys} socialPost={socialPost} setSocialPost={setSocialPost} copySocialPost={copySocialPost} openSocialComposer={openSocialComposer} socialLinks={socialLinks} />
    </div>
  );
};
...
const HostReviewWorkspace = ({ selectedSession, analytics, questionFeedback, categoryRows, playerIdeas, message, setMessage, sendUpdate, openEmailDraft, copyEmails, contacts, exportResults, scheduleNextShow, buildNextSession, aiDirection, setAiDirection, generateClues, generating, clueQuestionRows, selectedClueKeys, setSelectedClueKeys, socialPost, setSocialPost, copySocialPost, openSocialComposer, socialLinks }) => {
