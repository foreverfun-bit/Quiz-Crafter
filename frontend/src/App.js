...
import StyleMemory from "./pages/StyleMemory";
      ...
      <div className="App min-h-screen bg-[#09090B]">
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/manage" element={<ProtectedRoute><AppLayout><Manage /></AppLayout></ProtectedRoute>} />
            <Route path="/style-memory" element={<ProtectedRoute><AppLayout><StyleMemory /></AppLayout></ProtectedRoute>} />
